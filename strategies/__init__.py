...
from strategies.custom import FLAT_LIST, ALL_CUSTOM, DRAGON_FAMILY, MOMENTUM_FAMILY, END_OF_DAY_FAMILY

STRATEGIES = FLAT_LIST
STRATEGY_BY_NAME = {s.name: s for s in STRATEGIES}
__all__ = STRATEGIES + [
    BaseStrategy, "STRATEGIES", "STRATEGY_BY_NAME",
    "ALL_CUSTOM", "DRAGON_FAMILY", "MOMENTUM_FAMILY", "END_OF_DAY_FAMILY",
]